public class CategoryClient {
    public static void main(String[] args) {
        ProductCategory womanCategory = new Category(1234, "Woman", 0, "Woman");
        ProductCategory manCategory = new Category(5678, "Man", 0, "Man");
        ProductCategory clothesCategoryW = new Category(2345, "Clothes", 0, "Cloth(W)");
        ProductCategory bagCategoryW = new Category(3456, "Bag", 0, "Bag(W)");
        ProductCategory shoesCategoryW = new Category(9876, "Shoes", 0, "Shoes(W)");
        womanCategory.addProduct(clothesCategoryW);
        womanCategory.addProduct(bagCategoryW);
        womanCategory.addProduct(shoesCategoryW);
        ProductCategory clothesCategoryM = new Category(23450, "Clothes", 0, "Clothe(M)");
        ProductCategory bagCategoryM = new Category(34560, "Bag", 0, "Bag(M)");
        ProductCategory shoesCategoryM = new Category(98760, "Shoes", 0, "Shoes(M)");
        ...
        System.out.println(shoesCategoryW.getName());
        System.out.println();
        bagCategoryW.getProductList();
    }
}
